...
class GeminiDataSourceImpl @Inject constructor(
     ...
     * - Error messages are skipped — sending a failed AI response back as history
     *   confuses the model and wastes context window
     * - History is capped at the last 20 messages to avoid exceeding token limits
